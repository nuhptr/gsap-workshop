   ...
   return (
      <main>
         ...
         <p className="mt-5 text-gray-500">
            The <code>gsap.to</code> method is used to animate elements from their current state to
            a new state
         </p>
         ...
         <p className="mt-5 text-gray-500">
            ...
            <code>gsap.from()</code> method animates elements from a <strong>new state</strong> to
            their <strong>current state</strong>.
         </p>
