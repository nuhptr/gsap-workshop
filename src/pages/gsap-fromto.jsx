   ...
   return (
      <main>
         ...
         <p className="mt-5 text-gray-500">
            The <code>gsap.fromTo()</code> method is used to animate elements from a new state to a
            new state.
         </p>

         <p className="mt-5 text-gray-500">
            The <code>gsap.fromTo()</code> method is similar to the <code>gsap.from()</code> and{" "}
            <code>gsap.to()</code> methods, but the difference is that the{" "}
            <code>gsap.fromTo()</code> method animates elements from a new state to a new state,
            while the <code>gsap.from()</code> method animates elements from a new state to their
            current state, and the <code>gsap.to()</code> method animates elements from their
